...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `RandomPlayer<#471ce2>${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/sgrandom) Block Dash 1v1",
      descriptionKey: "TorneioX .GG/SGRANDOM Maps: Block Dash. Created By: PaoDoce daniel.ftw",
      ...
      prizeBannerColour: "#2c017a",
      headerColour: "#2f00ff",
      mapListGradientColourTop: "#300066",
      mapListGradientColourBottom: "#afa9ff",
      listPriority: 1,
      minPlayers: 2,
      maxPlayers: 2,
      maxRounds: 1,
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/sgrandom) Block Dash Legendary 3 Players",
      descriptionKey: "TorneioX .GG/SGRANDOM Maps: Block Dash Legendary. Created By: PaoDoce daniel.ftw",
